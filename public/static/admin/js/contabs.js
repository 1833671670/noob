$(function() {
    ...
    function c() {
        ...
        $(this).parents('.menu-next').addClass('active').siblings('li').removeClass('active');
        $(this).parent().addClass('sel').siblings('li').removeClass('sel');
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" name="iframe' + m + '" id="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
            $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(n);
            $(".J_menuTabs .page-tabs-content").append(p);
            g($(".J_menuTab.active"))
            
            return false;
            //var x = document.getElementById("#iframe"+m);
            var x = $(window.frames["iframe"+m].document);
            console.log(x.context.all[2].find('.row').html());
            //console.log(x.find('.row')[0].text());
            
        }
        if(!k){
        	
            $(".J_mainContent .J_iframe").each(function(event){
