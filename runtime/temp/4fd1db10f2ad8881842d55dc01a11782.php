<?php /*a:1:{s:101:"D:\phpstudy\PHPTutorial\WWW\noob\sjx20190429\tp5.1demo\application\admin\view\system\module_prev.html";i:1535624935;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
				...
				<div class="float-e-margins">
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="commentForm" method="post"
							action="<?php echo url('system/module_prev_ok'); ?>">
							
							
							<div class="zTreeDemoBackground left">
								<ul id="moduleTree" class="ztree" style="width:500px;"></ul>
							</div>
						    <input type="hidden" name="module_str" id="module_str" value="<?php echo htmlentities($info['module']); ?>" />
