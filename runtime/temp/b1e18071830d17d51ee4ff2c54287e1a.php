<?php /*a:1:{s:78:"E:\sjx\PHPTutorial\WWW\tp5.1demo\application\admin\view\mall\question_add.html";i:1536030229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
				...
				<div class="float-e-margins">
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="commentForm" method="post"
							action="<?php echo url('mall/question_ok'); ?>">
							<div class="form-group">
								<label class="col-sm-3 control-label">问题：</label>
								<div class="input-group col-sm-7">
									<textarea class="form-control" name="content" id="content"><?php if(!(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty()))): ?><?php echo htmlentities($info['content']); endif; ?></textarea>
								</div>
							</div>
